...
const SUBJECT = encodeURIComponent("Quiero agendar un diagnóstico con FEI");
const BODY = encodeURIComponent(
  "Hola equipo FEI,\n\n" +
    "Me gustaría agendar un diagnóstico para conocer cómo estructuran la evidencia documental de mis operaciones.\n\n" +
...
export default function FloatingDemoButton() {
  ...
  return (
    <a
      href={href}
      aria-label="Agenda un diagnóstico por correo"
    ...
    >
      ...
      <span className="ml-0 max-w-0 overflow-hidden whitespace-nowrap font-heading text-sm font-semibold text-white opacity-0 transition-all duration-300 group-hover:ml-3 group-hover:max-w-[210px] group-hover:opacity-100">
