  ...
  return (
    ...
    >
      <div className="container-site flex h-[74px] items-center justify-between px-5 sm:px-6 lg:px-8">
        ...
        >
          <img src={asset(brand.logo.main)} alt={brand.name} width={127} height={36} className="h-9 w-auto object-contain transition-transform duration-300 group-hover:scale-[1.03]" />
        </Link>
